...
function getContacts(filterBy = null) {
    return new Promise((resolve, reject) => {
        ...
        if (filterBy.name || filterBy.phone || filterBy.email) {
...
async function getContactAvatar(name) {
    const res = await axios.get(`https://avatars.dicebear.com/api/adventurer/${name}.svg`)
    return res.data
}